...
public class DataConfiguration {
    ...
    public List<User> getUsers() {
        ...
        LocalDate date7 = LocalDate.now().minusDays(5);
        LocalDate date8 = LocalDate.now().minusDays(8);
        LocalDate date9 = LocalDate.now().minusDays(15);
        ...
        users.add(new User(10, "Maria", new ArrayList<>(), List.of(1), new ArrayList<>(), false));
