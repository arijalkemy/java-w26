...
class ProductImplTest {
    ...
    @Test
    @DisplayName("Test Opcional: Creación de post cuando el usuario no existe")
    public void createPostWhenTheUserIsNotExistTest() {
        // Arrange
        PostRequestDto postRequestDto = GeneratorDataTest.getPostRequestDto();
        when(iUserRepository.findById(postRequestDto.getUserId())).thenReturn(null);
        // Act - Assert
