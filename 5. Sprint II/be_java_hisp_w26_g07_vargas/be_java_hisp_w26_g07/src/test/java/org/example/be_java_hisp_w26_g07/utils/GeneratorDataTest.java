...
public class GeneratorDataTest {
    ...
    public static PostRequestDto getPostRequestDto() {
        ProductDto productDto = new ProductDto(
                18, "Silla Gamer", "Gamer", "Racer", "Red y Black", "Especial Edition"
        );
        return new PostRequestDto(
                1, LocalDate.of(1996, 04, 29), productDto, 100, 1500.50
        );
    }

    public static PostRequestDto getPostRequestDtoWithInvalidData() {
        ProductDto productDto = new ProductDto(
                0, "Aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
                "", "racer", "Red & Black", "Especial Edition"
        );
        return new PostRequestDto(
                -8, LocalDate.of(1996, 04, 29), productDto, 100, 1999500.50
        );
    }
}
