...
public class ProductController {
    ...
    public ResponseEntity<PostListByBuyerResponseDTO> getPostByUser(@Positive(message = "El Id debe ser mayor a cero") @PathVariable int userId, @RequestParam String order){
