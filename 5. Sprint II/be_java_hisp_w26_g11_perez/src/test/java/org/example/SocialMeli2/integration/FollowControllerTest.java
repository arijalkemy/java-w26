...
public class FollowControllerTest {
    ...
    /**
     * Esta prueba verifica que la respuesta contenga el id del usuario, el nombre del usuario y el número de seguidores.
     * @throws Exception si ocurre algún error de procesamiento.
     */
    @Test
    ...
    /**
     * Esta prueba verifica que se lance una excepción cuando no se encuentra al usuario.
     * @throws Exception si ocurre algún error de procesamiento.
     */
    @Test
    ...
    /**
     * Esta prueba verifica que se lance una excepción cuando el id del usuario no es mayor que cero.
     * @throws Exception si ocurre algún error de procesamiento.
     */
    @Test
