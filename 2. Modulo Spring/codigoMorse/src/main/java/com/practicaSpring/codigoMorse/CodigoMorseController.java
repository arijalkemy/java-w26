...
public class CodigoMorseController {
    ...
    private Map<String, String> morseToAlpha = Map.ofEntries(
    ...
    private Map<Character, String> alphaToMorse = Map.ofEntries(
            new AbstractMap.SimpleEntry<>('a', ".-"),
            new AbstractMap.SimpleEntry<>('b', "-..."),
            new AbstractMap.SimpleEntry<>('c', "-.-."),
            new AbstractMap.SimpleEntry<>('d', "-.."),
    ...
    public String decodeMorse(@PathVariable String input) {
        ...
        for (String word : words){
            ...
            for (String letter : letters){
                response.append(morseToAlpha.get(letter).toUpperCase());
            }
            response.append(" ");
        }
    ...
    @GetMapping("/encodeMorse/{input}")
    public String encodeMorse(@PathVariable String input) {
        StringBuilder response = new StringBuilder();
        String[] words = input.split(" ");
        for (String word : words){
            for (char letter : word.toLowerCase().toCharArray()){
                response.append(alphaToMorse.get(letter));
                response.append(" ");
            }
            response.append("   ");
        }
