...
public class ProductServiceImpl implements ProductService {
    ...
    public void modifyPromoPost(ProductsPromoDto productsPromoDto) {
        postService.modifyPromoPost(productsPromoDto);
    }
    ...
    @Override
    public PostPromoRespDto getQuantityProductsPromo(Integer userId) {
       return postService.getQuantityProductsPromo(userId);
    }
