...
SELECT title, rating FROM movies WHERE LOWER(title) LIKE 'toy story';

-- 11: Mostrar a todos los actores cuyos nombres empiezan con Sam.
SELECT first_name, last_name FROM actors WHERE LOWER(first_name) LIKE 'sam%';
