...
select title, awards, release_date, rating from movies where rating > 3 and awards > 1 and release_date between '1988-01-01' and '2009-12-31' order by rating asc;