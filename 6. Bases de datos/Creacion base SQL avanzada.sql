...
SELECT nombre, puesto, localidad FROM empleado JOIN departamento ON empleado.depto_nro = departamento.depto_nro 
...
from Empleado as e inner join Departamento as d on e.depto_nro = d.depto_nro
...
FROM empleado e GROUP BY e.nombre ORDER BY min_sal ASC
LIMIT 1;

select e.* from Empleado as e
inner join Departamento as b on e.depto_nro = b.depto_nro where b.nombre_depto = 'Ventas'
