...
SELECT au.nombre, au.nacionalidad FROM Autor au WHERE (nacionalidad = 'francia' OR nacionalidad = 'italia');
...
SELECT e.nombre, e.apellido FROM Estudiante e WHERE apellido LIKE 'G%';
...
SELECT l.titulo FROM Libro l
INNER JOIN Prestamo p ON l.idLibro = p.idLibro
WHERE p.fechaDevolucion = '2021-07-16' AND p.devuelto = 1;