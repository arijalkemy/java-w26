...
('El universo: Guia de viaje', 'Salamandra', 'Infantil'),
('SQL con MELI', 'Salamandra', 'Bases de datos');
...
('Filippo', 'Galli', 'Avenida Central', 'Administración', 28);
...
(7, 6); -- No sabemos el autor es solo para la busqueda
...
(6, 5, '2024-05-05 10:00:00', '2024-05-19 10:00:00', 0), -- Filippo Galli prestó El código Da Vinci (no devuelto aún)
(6, 8, '2021-07-1', '2021-07-16', 1); -- Filippo Galli prestó Libro base de datos (no devuelto aún)