...
import com.mercadolibre.pf_be_hisp_w26_t10_gonzalez.jwt.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authRequest -> authRequest
                        ...
                        .requestMatchers("/api/v1/fresh-products/orders/**").hasAnyAuthority(Rol.BUYER.name(),Rol.SUPERVISOR.name(), Rol.SELLER.name())
...
//                        .requestMatchers("/api/v1/fresh-products/**").permitAll()
