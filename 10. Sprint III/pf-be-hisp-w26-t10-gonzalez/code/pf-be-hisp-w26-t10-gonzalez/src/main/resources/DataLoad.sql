...
INSERT INTO user_account (first_name, last_name, password, user_role, username, email) VALUES
    ...
    ('juan', 'gonzalez', '$2a$10$HApgftcY3m4qgHFiaPZQkuIck/Fxios/Vwn2HvPS5ccw1NPhjWxx.', 'SELLER', 'jgonz', ''),
    ('luis', 'meza', '$2a$10$dSxd1Ydm74kQeaQNqnWE9./ufOIPWWcfcO1AcK7WMivLBqyOyYBva', 'SELLER', 'mluis', ''),
    ('stiven', 'garcia', '$2a$10$iSeMgntSPi8x1d1eTYAvO.4N8PAiFIMlYmEDHbrfRz8IzbJklRVsS', 'SELLER', 'gstiven', ''),
...
INSERT INTO product (category_id, seller_id, name, price) VALUES
                                                              (1, 1, 'Pizza de Pepperoni', 8.99),
                                                              (2, 2, 'Zumo de Naranja Natural', 2.49),
                                                              (3, 3, 'Lechuga Iceberg', 1.99),
                                                              (1, 1, 'Filete de Salmón', 12.99),
                                                              (2, 2, 'Yogur Natural', 0.99),
                                                              (3, 3, 'Manzanas Gala', 3.49),
                                                              (1, 1, 'Helado de Chocolate', 3.99),
                                                              (2, 2, 'Queso Cheddar', 4.49),
                                                              (3, 3, 'Ensalada César', 5.99),
                                                              (1, 1, 'Pollo Congelado', 7.99),
                                                              (2, 2, 'Queso Panela', 11.99),
                                                              (2, 3, 'Gelatina Dani', 5.99);
