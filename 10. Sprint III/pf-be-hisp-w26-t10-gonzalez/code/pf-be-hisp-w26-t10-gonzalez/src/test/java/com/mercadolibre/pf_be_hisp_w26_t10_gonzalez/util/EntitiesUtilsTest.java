...
import com.mercadolibre.pf_be_hisp_w26_t10_gonzalez.dtos.BatchStockDTO;
import com.mercadolibre.pf_be_hisp_w26_t10_gonzalez.dtos.SectorDTO;
...
public class EntitiesUtilsTest {
    ...
    public static UserAccount seller(){
        UserAccount supervisor = new UserAccount();
        supervisor.setUserId(2L);
        supervisor.setFirstName("Jorge");
        supervisor.setLastName("Gomez");
        supervisor.setUsername("jgomez");
        supervisor.setPassword("$2a$10$QdjO1iHy/vOEpbIyb5gTuuysQWbrLOSzM8PTSL2kwWSUpL3NgYY0G");
        supervisor.setUserRole(Rol.SELLER);
