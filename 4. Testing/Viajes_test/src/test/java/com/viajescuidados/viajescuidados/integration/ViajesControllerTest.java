...
import static com.viajescuidados.entities.viajes.EstadoViaje.NO_INICIADO;
...
public class ViajesControllerTest {
    ...
    public void crearUnViajeTest() throws Exception {
        ...
        viaje.setPersona(new Persona(3, "Juan", "Perez"));

        ViajeResponseDTO respuestaEsperada = ViajeMapper.crearViajeResponseDTO(viaje);
        respuestaEsperada.setCuidadores(List.of(1, 2));
        respuestaEsperada.setDuracionEstimadaEnMins(2L);
        respuestaEsperada.setId(1);
