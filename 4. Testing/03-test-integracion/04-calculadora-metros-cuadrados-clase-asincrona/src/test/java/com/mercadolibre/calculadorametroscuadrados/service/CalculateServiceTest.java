...
public class CalculateServiceTest {
    ...
    public void CalculateService_calculate_HouseResponseShouldBeNotNull(){
    ...
    public void CalculateService_calculate_priceShouldBeCorrect(){
        RoomDTO room1 = RoomDTO.builder().name("Room 1").width(20).length(10).build();
        RoomDTO room2 = RoomDTO.builder().name("Room 2").width(30).length(15).build();
    ...
    public void CalculateService_calculate_SquareFeetAndPriceShouldBeGreaterThanZero(){
        RoomDTO room1 = RoomDTO.builder().name("Room 1").width(20).length(10).build();
        RoomDTO room2 = RoomDTO.builder().name("Room 2").width(30).length(15).build();
    ...
    public void CalculateService_calculate_biggestRoomShouldExists(){
        RoomDTO room1 = RoomDTO.builder().name("Room 1").width(20).length(10).build();
        RoomDTO room2 = RoomDTO.builder().name("Room 2").width(30).length(15).build();
    ...
    public void CalculateService_calculate_squareFeetShouldBeRight(){
        RoomDTO room1 = RoomDTO.builder().name("Room 1").width(20).length(10).build();
        RoomDTO room2 = RoomDTO.builder().name("Room 2").width(30).length(15).build();
    ...
    public void CalculateService_calculate_ShouldThrowNullPointerException(){
        List<RoomDTO> rooms = Arrays.asList(null, null);

        HouseDTO house = HouseDTO.builder().name("House").address("Av. 232").rooms(rooms).build();

        assertThrows(NullPointerException.class, () -> calculateService.calculate(house));
    }
}
