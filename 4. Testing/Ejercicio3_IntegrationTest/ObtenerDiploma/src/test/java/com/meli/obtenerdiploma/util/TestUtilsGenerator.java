...
public class TestUtilsGenerator {
    ...
    public static StudentDTO getStudentExistent() {
    ...
    public static StudentDTO getStudentWithInvalidData(Long id) {
        SubjectDTO subject1 = new SubjectDTO("matemática", 9.0);
        SubjectDTO subject2 = new SubjectDTO("loremipsumloremipsumloremipsumloremipsumlorem" +
                "ipsumloremipsumloremipsumloremipsumloremipsumloremipsumloremipsum", 11.0);
        SubjectDTO subject3 = new SubjectDTO("Física", -1.0);
        ...
        StudentDTO stu = new StudentDTO();
        stu.setId(id);
        stu.setStudentName("juanabcdeffghiklañljuanabcdeffghiklañljuanabcdeffgh" +
                "iklañljuanabcdeffghiklañljuanabcdeffghiklañljuanabcdeffghiklañlju" +
                "anabcdeffghiklañljuanabcdeffghiklañljuanabcdeffghiklañlanabcdeffghik" +
                "lañljuanabcdeffghiklañljuanabcdeffghiklañl"
        );
        stu.setSubjects(subjects);
        stu.setMessage(null);
        stu.setAverageScore(null);
