...
public class ObtenerDiplomaControllerTests {
    ...
    public void analyzeScoresOutput() throws Exception {
        StudentDTO student = getStudentWith3Subjects("Juan");
        StudentDTO expectedStudent = getStudentWith3Subjects("Juan");
        expectedStudent.setAverageScore(6.00);
        expectedStudent.setMessage("El alumno " + student.getStudentName() +
    ...
    public void analyzeScoresForNotExistingStudentOutput() throws Exception {
        Long studentId = 2L;
        String studentName = "Carlos";
        double expectedAverage = 7.33;
