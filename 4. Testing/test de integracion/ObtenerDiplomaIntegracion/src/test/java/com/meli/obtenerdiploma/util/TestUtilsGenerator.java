...
public class TestUtilsGenerator {
    ...
    public static void reestartJsonFile(Set<StudentDTO> students){
        AtomicLong index = new AtomicLong(1); // Iniciar el contador en 1
        TestUtilsGenerator.emptyUsersFile();
        for (StudentDTO s : students) {
            s.setId(index.getAndIncrement());
            TestUtilsGenerator.appendNewStudent(s);
        }
    }
    ...
    public static void appendNewStudent(Object stu) {
        ...
        try {
            ...
            writer = new PrintWriter(ResourceUtils.getFile("./src/" + SCOPE + "/resources/users.json"), "US-ASCII");
