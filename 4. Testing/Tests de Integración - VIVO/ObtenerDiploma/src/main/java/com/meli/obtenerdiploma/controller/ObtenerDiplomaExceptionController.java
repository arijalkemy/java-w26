...
public class ObtenerDiplomaExceptionController {
    ...
    ResponseEntity<ErrorDTO> handleStudentAlreadyExistException(StudentAlreadyExists e) {
        return new ResponseEntity<>(new ErrorDTO(e.getClass().getName(), e.getMessage()), HttpStatus.BAD_REQUEST);
    }
