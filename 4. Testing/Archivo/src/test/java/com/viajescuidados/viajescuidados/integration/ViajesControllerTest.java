...
public class ViajesControllerTest {
    ...
    @Test
    public void crearViajeCalculaLaDemoraTest() throws Exception {
        UbicacionDTO origen = new UbicacionDTO("", (long) -34.5, (long) -58.5);
        UbicacionDTO destino = new UbicacionDTO("", (long) -34.5, (long) -59);
        ViajeDTO viajeDTO = new ViajeDTO(List.of(1, 2), origen, destino);
        ...
        results
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json"))
                .andExpect(jsonPath("$.duracionEstimadaEnMins").value(2));
    }

    @Test
    public void crearViajeTieneCuidadores() throws Exception {
        UbicacionDTO origen = new UbicacionDTO("", (long) -34.5, (long) -58.5);
        UbicacionDTO destino = new UbicacionDTO("", (long) -34.5, (long) -59);
        List<Integer> cuidadoresEsperados = List.of(1,2);
        ViajeDTO viajeDTO = new ViajeDTO(cuidadoresEsperados, origen, destino);
        ...
        results
                ...
                .andExpect(
                        jsonPath("$.cuidadores")
                        .value(Matchers.containsInAnyOrder(cuidadoresEsperados.toArray())));
    }
