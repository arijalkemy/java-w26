...
public class TestUtilsGenerator {
    ...
    public static Set<StudentDTO> getStudentSetIntegration() {
        StudentDTO stu1 = getStudentWithId(1L);
        StudentDTO stu2 = new StudentDTO();
        SubjectDTO subject1 = new SubjectDTO("Matemática", 10.0);
        SubjectDTO subject2 = new SubjectDTO("Química", 4.0);
        SubjectDTO subject3 = new SubjectDTO("Física", 8.0);

        List<SubjectDTO> subjects = new ArrayList<>();
        subjects.add(subject1);
        subjects.add(subject2);
        subjects.add(subject3);
        stu2.setStudentName("Pedro");
        stu2.setId(2L);
