...
public class TestUtilsGenerator {
    ...
    public static StudentDTO getStudentWithId(Long id) {
        ...
        StudentDTO stu = new StudentDTO();
        stu.setId(id);
        stu.setStudentName("Agustin Tapia");
        stu.setSubjects(subjects);
    ...
    public static StudentDTO getStudent(String name, long id) {
        SubjectDTO subject1 = new SubjectDTO("Matematica", 8.0);
        SubjectDTO subject2 = new SubjectDTO("Lengua", 6.0);
        SubjectDTO subject3 = new SubjectDTO("Fisica", 4.0);
    ...
    public static Set<StudentDTO> getStudents() {
        StudentDTO stu1 = getStudent("Marco", 1L);
        StudentDTO stu2 = getStudent("Marco Polo", 2L);
        StudentDTO stu3 = getStudent("Julio", 3L);
        StudentDTO stu4 = getStudent("Julio Cesar", 4L);

        return new HashSet<>(){{add(stu1); add(stu2); add(stu3); add(stu4);}};
    }
    ...
    public static void loadData(Set<StudentDTO> students) {
