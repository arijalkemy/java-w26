...
public class SocialMeliController {
    ...
    */
    ...
    /*
    US Propuestas: Que devuelva todas las publicaciones de un vendedor sin importar si estan en promocion o no
     */
    @GetMapping("/{userId}/posts")
    public ResponseEntity<?> getPostBySeller(@PathVariable Integer userId){
        return ResponseEntity.status(HttpStatus.OK).body(iSellerService.getPost(userId));
    }
}
