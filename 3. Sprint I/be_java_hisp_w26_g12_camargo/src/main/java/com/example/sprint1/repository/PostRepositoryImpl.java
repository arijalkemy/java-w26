...
import static com.example.sprint1.service.PostServiceImpl.posts;
...
public class PostRepositoryImpl implements IPostRepository {
    ...
    @Override
    public List<Post> findAllByUserIdAndHasPromoTrue(Integer userId) {
        // Filtra los posts donde has_promo es true y el userId coincide
        return posts.stream()
