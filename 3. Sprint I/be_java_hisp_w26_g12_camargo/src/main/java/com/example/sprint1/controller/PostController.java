...
public class PostController {
    ...
    // finished method US0005
        ...
        public ResponseEntity<?> postPromo (@RequestBody PostDto postDto){
            //return postService.addPromotionalPost(postDto);
            return new ResponseEntity<>(postService.addPromotionalPost(postDto), HttpStatus.CREATED);
        }
        ...
        public ResponseEntity<PromoPostCountDto> getPromoPostCount(@RequestParam Integer user_id) {
            PromoPostCountDto result = postService.getPromoPostCount(user_id);
