...
public class SocialMediaExceptionHandler {
    ...
    public ResponseEntity<ExceptionDto> methodArgumentNotValid(MethodArgumentNotValidException ex) {
        ExceptionDto exdto = new ExceptionDto( ex.getFieldError().getField() + ": " +
