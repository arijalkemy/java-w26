...
public class UserController {
    ...
    @GetMapping("/{userId}/not-follower")
    public ResponseEntity<?> getNotFollowerUser(@PathVariable int userId){
        return new ResponseEntity(iUserService.getNotFollowersByUser(userId), HttpStatus.OK);
    }
}
