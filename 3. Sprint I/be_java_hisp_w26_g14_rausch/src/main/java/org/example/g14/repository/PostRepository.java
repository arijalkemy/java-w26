...
public class PostRepository implements IPostRepository{
    ...
    @Override
    public List<Post> getPostsInOrder() {
        List<Post> posts = listOfPosts;
        return posts.stream().filter(Post::isHasPromo).sorted(Comparator.comparing(Post::getDiscount).reversed()).collect(Collectors.toList());
    }
}
