...
public class SellerController {
    ...
    public ResponseEntity<String> createPromoPost(@RequestBody RequestPromoPostDTO promoPostDTO){
        postService.createPromoPost(promoPostDTO);
        return ResponseEntity.ok().body("Publicación de promoción creada con éxito");
    }

    @GetMapping("/promo-post/count")
    public ResponseEntity<ResponsePromoCountDTO> getPromoPostCount(@RequestParam (name = "user_id") int userId){
