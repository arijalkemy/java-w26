...
public class PostRepositoryImpl implements IPostRepository {
    ...
    private void initializePosts() {
        ...
        for (int i = 0; i < 55; i++) {
            ...
            int postId = listPost.size() + 1;

            Post post = new Post(postId, userId, date, product, category, price, false, 0.0);
    ...
    public Post getPostById(Integer postId) {
        return listPost.stream().filter(post -> post.getPostId().equals(postId)).findFirst().orElse(null);
    }
}
