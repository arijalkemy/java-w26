...
public class PostRepositoryImpl implements IPostRepository {
    ...
    @Override
    public void savePostWithPromo(PostWithPromoDto post) {
        this.post.add(new Post(post.getUser_id(), post.getDate(), post.getProduct(), post.getPost_id(), post.getCategory(), post.getPrice(), true, post.getDiscount()));
    }
}
