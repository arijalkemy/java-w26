...
public class DataConfiguration {
    ...
    HashMap<Integer, Post> getInitialPosts() {
        ...
        List<Post> postList = List.of(
                ...
                new Post(1, 2, date2, 2, 1, 199.99, false, 0.0),
                new Post(1, 3, date3, 3, 1, 499.99, false, 0.0),
                new Post(1, 4, date4, 4, 2, 29.99, false, 0.0),
                new Post(2, 5, date5, 5, 1, 299.99, false, 0.0),
                new Post(2, 6, date6, 6, 1, 199.99, false, 0.0),
                new Post(3, 7, date7, 7, 1, 149.99, false, 0.0),
                new Post(4, 8, date8, 8, 2, 49.99, false, 0.0),
                new Post(4, 9, date9, 9, 1, 699.99, false, 0.0),
                new Post(4, 10, date10, 10, 1, 79.99, false, 0.0)
        );
