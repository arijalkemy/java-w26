...
public class ProductController {
    ...
    @GetMapping("/list")
    public ResponseEntity<?> getProductsFilters(@RequestParam(required = false) String name,
        ...
        List<MainProductResponse> response = service.searchProducts(productFilterDTO);
