...
public class PostRepositoryImpl implements IPostRepository {
    ...
    /**
     * Gets all the posts with discount by userId
     * @param userId
     * @return
     */
    @Override
    public Integer getPostByUserId(Integer userId) {
    ...
    /**
     * Post product with discount
     * @param post
     * @return
     */
    @Override
    public Post postProductWithDiscount(Post post) {
        listOfPosts.add(post);
        return post;
    }

    /**
     * Get all the posts with discount of user with userId
     * @param userId
     * @return
     */
    @Override
    public List<Post> getProductWithDiscount(Integer userId) {
        return listOfPosts.stream()
                .filter(post -> post.isHas_promo() && post.getUser_id().equals(userId))
                .collect(Collectors.toList());
    }
