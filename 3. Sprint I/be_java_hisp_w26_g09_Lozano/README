...
- `US-0010 POST /products/promo-post`: Carry out the publication of a new promotional product
- `US-0011 GET /products/promo-post/count?user_id={userId}`: Obtain the number of products on promotion from a certain seller
- `US-0012 Bonus GET /products/get-all-post`: Get All post
- `US-0013 Bonus DELETE /products/delete-post"`: Delete a post
