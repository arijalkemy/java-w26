...
public class PostRepositoryImpl implements IPostRepository {
    ...
    @Override
    public Integer getPromoPosts(Integer user_id) {
        Integer numberOfPromoPost = post.stream().collect(Collectors.groupingBy(p -> p.getDiscount() > 0.0)).size();
        return numberOfPromoPost;
    }
}