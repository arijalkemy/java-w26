package com.mercadolibre.deportes_n.config;

import static com.mercadolibre.deportes_n.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.deportes_n.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("nvargasparra")
                .email("nilson.vargasparra@mercadolibre.com.co"));
