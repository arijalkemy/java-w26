...
public interface IVehiculoRepository extends JpaRepository<Vehiculo, Long> {
    ...
    @Query("SELECT v.patente AS patente, v.marca AS marca, v.modelo AS modelo, v.siniestros AS siniestros FROM Vehiculo v JOIN v.siniestros s WHERE s.perdidaEconomica > 10000")
    List<VehiculoConSiniestrosProjection> findVehiculosConSiniestrosMayoresA10000Projection();
}
