...
import com.mercadolibre.sprint3_individual_perez.jwt.JwtAuthenticationFilter;
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authRequest -> authRequest
                        .requestMatchers("/h2-console/**", "/auth/**").permitAll()
                                ...
                                .requestMatchers("/api/v1/fresh-products/new-product").hasAuthority("SELLER")
                                .requestMatchers("/api/v1/fresh-products/products").hasAuthority("SELLER")
