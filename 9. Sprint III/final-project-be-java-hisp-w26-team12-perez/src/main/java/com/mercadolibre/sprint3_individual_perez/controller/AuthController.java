...
import com.mercadolibre.sprint3_individual_perez.service.AuthServiceImpl;
import com.mercadolibre.sprint3_individual_perez.service.IAuthService;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerSeller(@RequestBody RegisterRequestDTO registerRequestDto){
        return new ResponseEntity<>(service.registerSeller(registerRequestDto), HttpStatus.CREATED);
    }
}
