...
import com.mercadolibre.sprint3_individual_perez.service.IInboundOrderService;
...
public class InBoundOrderController {
    ...
    public ResponseEntity<?> getInboundOrder() {
        return new ResponseEntity<>(inboundOrderService.getInboundOrders(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> createInboundOrder(@RequestBody CartDTO cartDTO, @PathVariable Long idOrder){
        return new ResponseEntity<>(inboundOrderService.updateInBoundOrder(cartDTO,idOrder), HttpStatus.CREATED);
    }
