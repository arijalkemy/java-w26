...
import com.mercadolibre.sprint3_individual_perez.repository.ICartRepository;
import com.mercadolibre.sprint3_individual_perez.service.CartServiceImpl;
...
public class CartServiceTest {
    ...
    void setup() {
        ...
        cartMock = new Cart();
        cartMock.setBuyer(uss);
        cartMock.setOrderStatus(OrderStatus.CARRITO);
        cartMock.setCarDate(Date.valueOf("2024-10-10"));
        cartMock.setId(1L);
        ProductInCart productInCart1 = new ProductInCart(1L,10, new Product(1L,"Sample 1",43.5, Category.FF,null,null,uss), cartMock);
        ProductInCart productInCart2 = new ProductInCart(2L,5, new Product(2L,"Sample 2",23.5, Category.FF,null,null,uss), cartMock);
