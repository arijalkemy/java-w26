...
import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.dto.frescos.WarehouseDTO;
...
public interface IProductRepository extends JpaRepository<Product,Integer> {
    ...
    @Query("SELECT new com.mercadolibre.pf_be_hisp_w26_t11_pacheco.dto.frescos.WarehouseDTO(w.warehouseCode, SUM(b.currentQuantity)) " +
