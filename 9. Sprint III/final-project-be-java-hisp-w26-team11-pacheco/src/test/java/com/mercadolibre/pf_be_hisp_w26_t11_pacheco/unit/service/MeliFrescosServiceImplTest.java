package com.mercadolibre.pf_be_hisp_w26_t11_pacheco.unit.service;

import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.dto.frescos.*;
import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.exceptions.ApiException;

import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.model.*;
import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.exceptions.BadRequestException;
import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.exceptions.NotFoundException;
import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.repository.*;

import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.service.MeliFrescosServiceImpl;
...
import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.model.ProductType;

import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.dto.frescos.BatchSearchStockResponseDTO;
import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.model.Section;
import com.mercadolibre.pf_be_hisp_w26_t11_pacheco.repository.IBatchRepository;
...
//        Act & Assert
    ...
    // Test for Req6: listBatchesOfProductInWarehouse
    @Test
    public void testListBatchesOfProductInWarehouse_ProductAndWarehouseExist_BatchesFound() {
        // Arrange
        Integer productId = 1;
        ...
        when(batchRepository.findByProductAndWarehouse(product, warehouse)).thenReturn(batches);

        // Act
        List<BatchStockResponseDTO> result = meliFrescosService.listBatchesOfProductInWarehouse(productId, warehouseId);
    ...
    @Test
    public void testListBatchesOfProductInWarehouse_ProductDoesNotExist() {
        // Arrange
        Integer productId = 1;
        Integer warehouseId = 1;
        ...
        // Act & Assert
        assertThrows(NotFoundException.class, () -> meliFrescosService.listBatchesOfProductInWarehouse(productId, warehouseId));
    }

    @Test
    public void testListBatchesOfProductInWarehouse_WarehouseDoesNotExist() {
        // Arrange
        Integer productId = 1;
        Integer warehouseId = 1;
        Product product = new Product();
    ...
    @Test
    public void testListBatchesOfProductInWarehouse_NoBatchesFound() {
        // Arrange
        Integer productId = 1;
        Integer warehouseId = 1;
        Product product = new Product();
        ...
        when(productRepository.findById(productId)).thenReturn(Optional.of(product));
        when(warehouseRepository.findById(warehouseId)).thenReturn(Optional.of(warehouse));
        when(batchRepository.findByProductAndWarehouse(product, warehouse)).thenReturn(Collections.emptyList());
