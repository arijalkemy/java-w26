...
import static com.mercadolibre.project_be_java_hisp_w26_team5.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.project_be_java_hisp_w26_team5.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("jlrodriguez")
                .email("joel.rodriguez@mercadolibre.com"));
