...
import com.mercadolibre.pf_be_hisp_w26_t10_garcia.service.implementations.WarehouseServiceImpl;
...
public class SearchServiceControllerTest {
    ...
    public void sectorProductBatchNotFoundFilterTest() {
        ...
        //Asserts
        Assertions.assertThrows(BadRequestException.class, () -> searchService.searchProduct(1, "X"));
