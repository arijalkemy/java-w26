...
import com.mercadolibre.pf_be_hisp_w26_t10_garcia.dtos.order.PurchaseOrderProduct;
import com.mercadolibre.pf_be_hisp_w26_t10_garcia.dtos.order.PurchaseOrderRequestBodyDto;
import com.mercadolibre.pf_be_hisp_w26_t10_garcia.dtos.order.PurchaseOrderRequestDto;
...
import com.mercadolibre.pf_be_hisp_w26_t10_garcia.service.IShoppingCartService;
       ...
       /* Validate if the user is owner of the order */
        ...
        List<ShoppingCartProduct> products = purchaseOrder.getProducts()
                ...
                .map(productFromPurchaseOrder -> ShoppingCartProduct
                        .builder()
                        .shoppingCard(shoppingCartExists.get())
