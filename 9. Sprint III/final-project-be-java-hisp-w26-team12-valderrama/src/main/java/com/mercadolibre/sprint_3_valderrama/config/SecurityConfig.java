package com.mercadolibre.sprint_3_valderrama.config;

import com.mercadolibre.sprint_3_valderrama.jwt.JwtAuthenticationFilter;
                ...
                .authorizeHttpRequests(authRequest -> authRequest
                        .requestMatchers("/h2-console/**",
                               ...
                               // .requestMatchers("/api/v1/demoAdmin").hasAuthority("ADMIN")
                                ...
                                //.requestMatchers("api/v1/fresh-products/list/outed/{idWarehouse}").hasAuthority("ADMIN")
                                //.requestMatchers("/api/v1/fresh-products/batch/list/expired/{idWarehouse}").hasAuthority("ADMIN")
