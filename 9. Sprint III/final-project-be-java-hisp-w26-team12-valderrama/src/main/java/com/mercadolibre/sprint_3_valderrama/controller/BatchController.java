...
public class BatchController {
    ...
    @GetMapping("/batch/list/expired/{idWarehouse}")
    public ResponseEntity<?> getExpiredBatches(@PathVariable Long idWarehouse) {
        return new ResponseEntity<>(batchService.getExpiredBatches( idWarehouse), HttpStatus.OK);
    }

    @GetMapping("/batch/list/outed/{idWarehouse}")
    public ResponseEntity<?> getOutedBatches(@PathVariable Long idWarehouse) {
        return new ResponseEntity<>(batchService.getOutedBatches(idWarehouse), HttpStatus.OK);
    }
}
