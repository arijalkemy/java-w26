...
import com.mercadolibre.pf_be_hisp_w26_t01_arguello.security.JwtService;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        boolean existUser = userRepository.findByEmail(request.getEmail()).isPresent();

        if(existUser){
            throw new ApiException("Bad Request","Ya existe un usuario con ese email.",400);
        }
