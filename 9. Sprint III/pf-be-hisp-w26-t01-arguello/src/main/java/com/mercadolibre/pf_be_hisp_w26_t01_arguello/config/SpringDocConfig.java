package com.mercadolibre.pf_be_hisp_w26_t01_arguello.config;

import static com.mercadolibre.pf_be_hisp_w26_t01_arguello.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t01_arguello.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("jcoro")
                .email("juanmanuel.coro@mercadolibre.com"));
