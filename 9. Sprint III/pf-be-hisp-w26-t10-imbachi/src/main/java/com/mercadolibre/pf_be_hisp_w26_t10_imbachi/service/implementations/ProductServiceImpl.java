...
public class ProductServiceImpl implements IProductService {
    ...
    @Override
    public NewProductDto saveProduct(NewProductDto productDto) {
        Optional<Product> check = productRepository.findById(productDto.getId());
        if(check.isEmpty()){
        ...
        throw new NotFoundException("El Id ya se encuentra en la base de datos");
    }
}
