package com.mercadolibre.pf_be_hisp_w26_t11_roman.controller;
...
import com.mercadolibre.pf_be_hisp_w26_t11_roman.service.IMeliFrescosService;
...
public class MeliFrescosController {
     ...
     * @throws com.mercadolibre.pf_be_hisp_w26_t11_roman.exceptions.NotFoundException
     */
    ...
    /**
     * Requerimiento 6.1: Mostrar los batches donde un  producto esta disponible para el proceso de picking en una orden de compra
     * @param orderId
     * @return PickingResponseDTO
     * @throws BadRequestException
     */
    @GetMapping("/fresh-products/orders/{orderId}/batch-list")
    public ResponseEntity<PickingResponseDTO> listBatchesOfProductInPurchaseOrder(@PathVariable Integer orderId) {

        return new ResponseEntity<>(service.listAvailableBatchesForPicking(orderId),HttpStatus.OK);
    }

    /**
     * Requerimiento 6.2: Mostrar los productos que estan en un carrito de compras
     * @return List<StarProductsDTO>
     * @throws BadRequestException
     */
    @GetMapping("/fresh-products/products/cart")
    public ResponseEntity<List<StarProductsDTO>> listBatchesOfProductInCart() {
        return new ResponseEntity<>(service.listProductsInCart(),HttpStatus.OK);
    }
}
