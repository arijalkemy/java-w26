package com.mercadolibre.pf_be_hisp_w26_t11_roman.config;

import com.mercadolibre.pf_be_hisp_w26_t11_roman.jwt.JwtAuthenticationFilter;
import com.mercadolibre.pf_be_hisp_w26_t11_roman.model.Role;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authRequest -> authRequest
                        ...
                        .requestMatchers("/api/v1/fresh-products/orders/{orderId}/batch-list").hasAuthority(Role.WAREHOUSE.name())
                        .requestMatchers("/api/v1/fresh-products/products/cart").hasAuthority(Role.WAREHOUSE.name())
