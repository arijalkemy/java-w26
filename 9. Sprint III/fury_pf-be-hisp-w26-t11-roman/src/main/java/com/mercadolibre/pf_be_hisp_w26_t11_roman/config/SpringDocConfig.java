...
import static com.mercadolibre.pf_be_hisp_w26_t11_roman.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t11_roman.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("cromanzuniga")
                .email("cesar.romanzuniga@mercadolibre.com.mx"));
