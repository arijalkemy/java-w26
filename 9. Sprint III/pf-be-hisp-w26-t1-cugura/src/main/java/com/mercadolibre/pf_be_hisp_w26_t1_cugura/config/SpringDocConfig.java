...
import static com.mercadolibre.pf_be_hisp_w26_t1_cugura.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t1_cugura.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("icugura")
                .email("ignacio.cugura@mercadolibre.com"));
