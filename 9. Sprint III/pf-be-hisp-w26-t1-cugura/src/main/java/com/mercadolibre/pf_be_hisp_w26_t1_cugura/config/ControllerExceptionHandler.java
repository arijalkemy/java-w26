package com.mercadolibre.pf_be_hisp_w26_t1_cugura.config;

import com.mercadolibre.pf_be_hisp_w26_t1_cugura.exceptions.ApiError;
...
public class ControllerExceptionHandler {
  ...
  protected ResponseEntity<ApiError> handleBadCredentialsException(BadCredentialsException e){
    ...
    ApiError apiError = new ApiError("bad_credentials","Credentials sended for user are wrong",HttpStatus.BAD_REQUEST.value());
    return ResponseEntity.status(apiError.getStatus()).body(apiError);
  }
}
