...
import static com.mercadolibre.pf_be_hisp_w26_t10_hoyos.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t10_hoyos.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("nhoyos")
                .email("nicolas.hoyos@mercadolibre.com.co"));
