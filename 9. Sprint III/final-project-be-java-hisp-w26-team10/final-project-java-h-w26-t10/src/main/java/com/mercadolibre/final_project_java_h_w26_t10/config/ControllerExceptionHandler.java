package com.mercadolibre.final_project_java_h_w26_t10.config;

import com.mercadolibre.final_project_java_h_w26_t10.dtos.ErrorResponseDto;
import com.mercadolibre.final_project_java_h_w26_t10.exceptions.ApiError;
import com.mercadolibre.final_project_java_h_w26_t10.exceptions.ApiException;
import com.mercadolibre.final_project_java_h_w26_t10.exceptions.NotFoundException;
import com.mercadolibre.final_project_java_h_w26_t10.exceptions.BadRequestException;
import com.mercadolibre.final_project_java_h_w26_t10.exceptions.NotFoundException;
...
public class ControllerExceptionHandler {
  ...
  /**
   * Handler for the not found exception
   * @param e
   * @return {@link ErrorResponseDto} return a message with the cause of the error with 404 status
   */
  @ExceptionHandler(NotFoundException.class)
  protected ResponseEntity<ErrorResponseDto> handlerNotFoundException(NotFoundException e){
    return new ResponseEntity<>(ErrorResponseDto.builder().message(e.getMessage()).build(), HttpStatus.NOT_FOUND);
  }

  /**
   * Handler for a bad request exception
   * @param e
   * @return {@link ErrorResponseDto} return a message with the cause of the error with 400 status
   */
