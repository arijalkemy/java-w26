...
public class BatchController {
    ...
    @GetMapping("/batch/list/scarce/{scarceLimit}")
    ResponseEntity<?> getDueBatchesByScarceLimit(@PathVariable Long scarceLimit){
        return ResponseEntity.ok(batchService.getAllScarceProducts(scarceLimit));
    }
}
