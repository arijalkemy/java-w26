...
import com.mercadolibre.sprint_3_team_12.service.CartServiceImpl;
...
public class CartServiceTest {
    ...
    void setup() {
        ...
        cartMock.setId(1L);
        ProductInCart productInCart1 = new ProductInCart(1L,10, new Product(1L,"Sample 1",43.5, Category.FF,null,null, null), cartMock);
        ProductInCart productInCart2 = new ProductInCart(2L,5, new Product(2L,"Sample 2",23.5, Category.FF,null,null, null), cartMock);
