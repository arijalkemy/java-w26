...
public class InboundOrderTest {
    ...
    public void setUp() throws Exception {
        ...
        manufacturingTime = LocalDateTime.parse("2023-01-01 10:00:00", formatter);
        dueDate = LocalDate.parse("2025-08-18");
    ...
    public void createInboundOrderWithInvalidDueDate() throws Exception {
        dueDate = LocalDate.parse("2023-08-18");
    ...
    public void createInboundOrderWithInvalidManufacturingDate() throws Exception {
        manufacturingDate = LocalDate.parse("2026-08-18");
        dueDate = LocalDate.parse("2025-08-18");
