...
import static com.mercadolibre.final_project_java_hisp_w26_t6.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.final_project_java_hisp_w26_t6.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("matiasdaniep")
                .email("matiasdaniel.pinto@mercadolibre.com"));
