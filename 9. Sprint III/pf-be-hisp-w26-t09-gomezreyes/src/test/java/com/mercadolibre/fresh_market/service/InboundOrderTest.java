...
import com.mercadolibre.fresh_market.service.impl.InboundOrderImplService;
...
import static org.junit.jupiter.api.Assertions.*;
 ...
 class InboundOrderTest {
    ...
    @InjectMocks
    InboundOrderImplService inboundOrderService;
    ...
    @Test
     void testCreateInboundOrder_Success() {
        // Arrange
        ...
        when(warehouseRepository.findById(inboundOrderDTO.getSectionDTO().getWarehouseCode())).thenReturn(Optional.of(warehouse));
        when(sectionRepository.findById(inboundOrderDTO.getSectionDTO().getSectionCode())).thenReturn(Optional.of(section));
        ...
        // Act
        List<BatchDTO> result = inboundOrderService.createInboundOrder(inboundOrderReqDTO);
    ...
    @Test
     void testUpdateInboundOrder_Success() {
        // Arrange
        InboundOrderReqDTO inboundOrderReqDTO = new InboundOrderReqDTO();
        InboundOrderDTO inboundOrderDTO = new InboundOrderDTO(10, LocalDate.now(), new SectionDTO(1L, 1L), new ArrayList<>());
        inboundOrderReqDTO.setInboundOrderDTO(inboundOrderDTO);
        ...
        // Act
        List<BatchDTO> result = inboundOrderService.updateInboundOrder(1L, inboundOrderReqDTO);
    ...
    @Test
     void testCreateInboundOrder_Failure() {
        // Arrange
        InboundOrderReqDTO inboundOrderReqDTO = new InboundOrderReqDTO();
        InboundOrderDTO inboundOrderDTO = new InboundOrderDTO(10, LocalDate.now(), new SectionDTO(1L, 1L), new ArrayList<>());
        inboundOrderReqDTO.setInboundOrderDTO(inboundOrderDTO);
        ...
        // Act and Assert
        assertThrows(BadRequestException.class, () -> inboundOrderService.createInboundOrder(inboundOrderReqDTO));
    }

    @Test
    void testUpdateInboundOrder_Failure() {
        // Arrange
        InboundOrderReqDTO inboundOrderReqDTO = new InboundOrderReqDTO();
        InboundOrderDTO inboundOrderDTO = new InboundOrderDTO(10, LocalDate.now(), new SectionDTO(1L, 1L), new ArrayList<>());
        inboundOrderReqDTO.setInboundOrderDTO(inboundOrderDTO);
        ...
        // Act and Assert
        assertThrows(BadRequestException.class, () -> inboundOrderService.updateInboundOrder(1L, inboundOrderReqDTO));
    }

    @Test
     void testCreateInboundOrder_WarehouseNotFound() {
        // Arrange
        InboundOrderReqDTO inboundOrderReqDTO = new InboundOrderReqDTO();
        InboundOrderDTO inboundOrderDTO = new InboundOrderDTO(10, LocalDate.now(), new SectionDTO(1L, 1L), new ArrayList<>());
        inboundOrderReqDTO.setInboundOrderDTO(inboundOrderDTO);

        when(warehouseRepository.findById(inboundOrderDTO.getSectionDTO().getWarehouseCode()))
                .thenThrow(new BadRequestException("Warehouse not found"));
    ...
    @Test
     void testCreateInboundOrder_UserCannotCreateInboundOrder() {
        // Arrange
        InboundOrderReqDTO inboundOrderReqDTO = new InboundOrderReqDTO();
        InboundOrderDTO inboundOrderDTO = new InboundOrderDTO(10, LocalDate.now(), new SectionDTO(1L, 1L), new ArrayList<>());
        inboundOrderReqDTO.setInboundOrderDTO(inboundOrderDTO);
    ...
    @Test
     void testCreateInboundOrder_SectionWarehouseCodeNotMatch() {
        // Arrange
        InboundOrderReqDTO inboundOrderReqDTO = new InboundOrderReqDTO();
    ...
    @Test
     void testListBatchToListBatchDTO() {
        // Arrange
    ...
    @Test
     void testSetInboundOrderToBatches() {
        // Arrange
