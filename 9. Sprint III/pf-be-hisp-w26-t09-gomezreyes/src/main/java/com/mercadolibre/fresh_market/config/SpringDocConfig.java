...
import static com.mercadolibre.fresh_market.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.fresh_market.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("ftrujillo")
                .email("fabian.trujillo@mercadolibre.com.co"));
