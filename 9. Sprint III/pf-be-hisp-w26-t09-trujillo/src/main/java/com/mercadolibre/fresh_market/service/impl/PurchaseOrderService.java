...
public class PurchaseOrderService implements IPurchaseOrderService {
     ...
     * This method checks if the user has the correct role, validates the existence of the products,
     * validates the stock, and saves the purchase order in the database.
     *
     * @param purchaseOrderDTO The data transfer object containing the details of the order.
     * @param userDetails The details of the authenticated user.
     * @return A Response object with the total price of the order.
     * @throws NoRolePermitionsException if the user does not have the correct role.
     * @throws ProductNotFoundException if a product in the order was not found.
     * @throws NoStockAvavility if there is not enough stock for the order.
     */
    @Override
    @PreAuthorize("hasRole('ROLE_BUYER')")
     ...
     * This method checks if the user has the correct role, fetches the purchase order from the database,
     * and returns a ProjectionPurchaseOrder object containing the products.
     *
     * @param idOrder The ID of the order.
     * @return A ProjectionPurchaseOrder object containing the products of the order.
     * @throws NoRolePermitionsException if the user does not have the correct role.
     * @throws EntityNotFound if the order with the given ID is not found.
     */
    @Override
    @PreAuthorize("hasRole('ROLE_BUYER')")
    @Transactional
