...
import com.mercadolibre.pf_be_hisp_w26_t10_guzmanq.jwt.JwtAuthenticationFilter;
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authRequest -> authRequest
                       ...
                       // .requestMatchers("/api/v1/fresh-products/inboundorder").permitAll()
                        ...
                        .requestMatchers("/api/v1/fresh-products/warehouse/{idWarehouse}/sales/**").hasAnyAuthority(String.valueOf(Rol.SUPERVISOR))
