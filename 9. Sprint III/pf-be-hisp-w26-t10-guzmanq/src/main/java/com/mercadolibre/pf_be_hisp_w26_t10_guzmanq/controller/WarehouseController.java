...
public class WarehouseController {
    ...
    @GetMapping("/warehouse/{idWarehouse}/sales")
    public ResponseEntity<?> getSalesInLastMonth(@PathVariable Integer idWarehouse) {
        return new ResponseEntity<>(this.shoppingCartService.getSalesInLastMonth(idWarehouse), HttpStatus.OK);
    }
     ...
     */
    @PreAuthorize("hasRole('SUPERVISOR')")
    @GetMapping("/warehouse/{idWarehouse}/sales/products/best-selling")
    public ResponseEntity<?> findBestSellingProductInLastMonth(@PathVariable Integer idWarehouse) {
        return new ResponseEntity<>(this.shoppingCartService.findBestSellingProductInLastMonth(idWarehouse), HttpStatus.OK);
    }
}
