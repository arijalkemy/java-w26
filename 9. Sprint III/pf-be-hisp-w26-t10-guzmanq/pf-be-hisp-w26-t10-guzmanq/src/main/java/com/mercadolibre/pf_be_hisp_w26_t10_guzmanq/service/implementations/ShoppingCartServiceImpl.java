...
//        Double totalSales = shoppingCartRepository.getTotalSalesForMonth(idWarehouse);
//        if (totalSales == null)
...
//        Double totalProducts = shoppingCartProductRepository.getTotalProductsSalesForMonth(idWarehouse);
