package com.mercadolibre.meli_frescos.config;

import static com.mercadolibre.meli_frescos.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.meli_frescos.util.ScopeUtils.isLocalScope;
