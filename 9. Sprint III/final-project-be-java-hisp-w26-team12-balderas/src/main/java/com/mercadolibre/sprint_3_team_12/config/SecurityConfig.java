        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authRequest -> authRequest
                        .requestMatchers("/h2-console/**", "/auth/**").permitAll()
                                ...
                                .requestMatchers("/api/v1/fresh-products").hasAuthority("ADMIN")
                                .requestMatchers("/api/v1/fresh-products/updateproduct").hasAuthority("ADMIN")
                                .requestMatchers("/api/v1/fresh-products/createproduct").hasAuthority("ADMIN")
