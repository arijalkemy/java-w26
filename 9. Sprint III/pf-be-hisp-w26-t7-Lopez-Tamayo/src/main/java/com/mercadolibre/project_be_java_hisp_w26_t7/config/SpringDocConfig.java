...
import static com.mercadolibre.project_be_java_hisp_w26_t7.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.project_be_java_hisp_w26_t7.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("carcardozo")
                .email("carlos.cardozo@mercadolibre.com.co"));
