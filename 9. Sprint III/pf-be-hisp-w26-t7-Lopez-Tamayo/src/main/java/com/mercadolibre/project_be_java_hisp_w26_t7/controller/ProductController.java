...
public class ProductController {
    ...
    public ResponseEntity<BatchListResponseDTO> getBatchListByProduct(
        @PathVariable Long idProduct, @RequestParam(required = false) String order
    ) {
        return ResponseEntity.status(HttpStatus.OK).body(productService.findBatchListByProduct(idProduct, order));
    }
