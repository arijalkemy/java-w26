...
class OrderControllerTest {
    ...
    void createProductListTest() {
        // Arrange
        when(orderService.saveProductList(null)).thenReturn(null);
        // Act
        orderController.createProductList(null);
        // Assert
    ...
    void updateProductListTest() {
        // Arrange
        when(orderService.updateProductList(null, null)).thenReturn(null);
        // Act
