...
import static com.mercadolibre.pf_be_hisp_w26_t4_aquino.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t4_aquino.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("jocorvalan")
                .email("jorge.corvalan@mercadolibre.com"));
