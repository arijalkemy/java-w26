package com.mercadolibre.pf_be_hisp_w26_t01_ditta.config;

import static com.mercadolibre.pf_be_hisp_w26_t01_ditta.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t01_ditta.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("mditta")
                .email("marcos.ditta@mercadolibre.com"));
