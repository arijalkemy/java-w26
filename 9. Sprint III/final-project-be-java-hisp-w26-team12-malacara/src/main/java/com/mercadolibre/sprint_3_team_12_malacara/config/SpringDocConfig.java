...
import static com.mercadolibre.sprint_3_team_12_malacara.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.sprint_3_team_12_malacara.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("yvalderrama")
                .email("yair.valderrama@mercadolibre.com.mx"));
