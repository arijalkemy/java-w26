...
INSERT INTO section (capacity,type,warehouse_id) VALUES (5,'FS',1),(5,'RF',1),(5,'FF',1),(4,'FS',2),(4,'RF',2),(4,'FF',2),(3,'FS',3),(3,'RF',3),(3,'FF',3),(2,'FS',4),(2,'RF',4),(2,'FF',4),(1,'FS',5),(1,'RF',5),(1,'FF',5);

INSERT INTO product (name, price, type) VALUES ('Product 1', 10.25, 'FS'),('Product 2', 15.50,'RF'),('Product 3', 20.75,'FF'),('Product 4', 25.00, 'FS'),('Product 5', 30.25,'RF'),('Product 6', 35.50,'FF'),('Product 7', 40.75, 'FS'),('Product 8', 45.00,'RF'),('Product 9', 50.25,'FF'),('Product 10', 55.50, 'FS'),('Product 11', 60.75,'RF'),('Product 12', 65.00,'FF'),('Product 13', 70.25, 'FS'),('Product 14', 75.50,'RF'),('Product 15', 80.75,'FF'),('Product 16', 85.00, 'FS'),('Product 17', 90.25,'RF'),('Product 18', 95.50,'FF'),('Product 19', 100.75, 'FS'),('Product 20', 105.00,'RF'),('Product 21', 110.25,'FF'),('Product 22', 115.50, 'FS'),('Product 23', 120.75,'RF'),('Product 24', 125.00,'FF'),('Product 25', 130.25, 'FS'),('Product 26', 135.50,'RF'),('Product 27', 140.75,'FF'),('Product 28', 145.00, 'FS'),('Product 29', 150.25,'RF'),('Product 30', 155.50,'FF');
...
INSERT INTO batch_stock(batch_stock_id, current_temperature, minimum_temperature, initial_quantity, current_quantity, manufacturing_date, manufacturing_time, due_date, inbound_order_id, product_id, user_id) VALUES (1, 10.0, 5.0, 1, 1, '2025-01-01', '2025-01-01T10:00:00', '2025-01-02', 1, 1, 5),(2, 10.0, 5.0, 1, 1, '2025-01-02', '2025-01-02T10:00:00', '2025-01-03', 2, 4, 5),(3, 10.0, 5.0, 1, 1, '2025-01-03', '2025-01-03T10:00:00', '2025-01-04', 3, 7, 5),(4, 10.0, 5.0, 1, 1, '2025-01-04', '2025-01-04T10:00:00', '2025-01-05', 4, 10, 5),(5, 10.0, 5.0, 1, 1, '2025-01-05', '2025-01-05T10:00:00', '2025-01-06', 5, 13, 5),(6, 10.0, 5.0, 2, 2, '2025-01-01', '2025-01-01T10:00:00', '2025-01-02', 6, 2, 5),(7, 10.0, 5.0, 2, 2, '2025-01-02', '2025-01-02T10:00:00', '2025-01-03', 7, 5, 5),(8, 10.0, 5.0, 3, 3, '2025-01-01', '2025-01-01T10:00:00', '2025-01-02', 8, 3, 5),(9, 10.0, 5.0, 2, 2, '2025-01-01', '2025-01-01T10:00:00', '2025-01-02', 9, 1, 5),(10, 10.0, 5.0, 2, 2, '2025-01-01', '2025-01-01T10:00:00', '2025-01-02', 10, 2, 5),(11, 10.0, 5.0, 2, 2, '2025-01-01', '2025-01-01T10:00:00', '2025-01-02', 11, 6, 5);
