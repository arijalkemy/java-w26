package com.mercadolibre.pf_be_hisp_w26_t11_perez.unit.service;

import com.mercadolibre.pf_be_hisp_w26_t11_perez.dto.frescos.*;
import com.mercadolibre.pf_be_hisp_w26_t11_perez.dto.frescos.BatchSearchStockResponseDTO;
...
import com.mercadolibre.pf_be_hisp_w26_t11_perez.repository.IBatchRepository;
import com.mercadolibre.pf_be_hisp_w26_t11_perez.service.MeliFrescosServiceImpl;
...
//        Arrange
        ...
        assertEquals(20.0, response.getTotalCost());
    }
...
//        Assert
        Assertions.assertNotNull(response);
        assertEquals(30.0, response.getTotalCost());
    }
...
//        Act & Assert
    ...
    public void createInboundOrderTest() {
        ...
        assertEquals(2, inboundOrder.getOrderNumber());
        assertEquals(user, warehouse.getRepresentative());
    ...
    public void createInboundOrderErrorInboundOrderExistTest() {
        ...
        try {
            ...
            assertEquals("Inbound Order ya existe", e.getCode());
        }
    }
    ...
    public void createInboundOrderErrorWarehouseTest() {
        ...
        try {
            ...
            assertEquals("Warehouse no existe", e.getCode());
        }
    ...
    public void createInboundOrderErrorSectionTest() {
        ...
        try {
            ...
            assertEquals("Section no existe", e.getCode());
        }
    }
    ...
    public void updateInboundOrderTest() {
        ...
        assertEquals(inboundOrderResponseDTO, response);
    }
    ...
    public void updateInboundOrderErrorInboundOrderNotExistTest() {
        ...
        try {
            ...
            assertEquals("Inbound Order not found", e.getCode());
        }
    }
    ...
    public void updateInboundOrderErrorWarehouseTest() {
        ...
        try {
            ...
            assertEquals("Warehouse not found", e.getCode());
        }
    }
    ...
    public void updateInboundOrderErrorSectionTest() {
        ...
        try {
            ...
            assertEquals("Section not found", e.getCode());
        }
    }
    ...
    public void updateInboundOrderErrorBatchTest() {
        ...
        try {
            ...
            assertEquals("Batch not found", e.getCode());
        }
    }
    ...
    public void updateInboundOrderErrorSectionCapacityTest() {
        ...
        try {
            ...
            assertEquals("Section capacity exceeded", e.getCode());
        }
    }
