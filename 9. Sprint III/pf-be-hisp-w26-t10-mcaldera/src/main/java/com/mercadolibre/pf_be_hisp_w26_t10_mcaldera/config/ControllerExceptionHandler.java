...
import com.mercadolibre.pf_be_hisp_w26_t10_mcaldera.dtos.ErrorResponseDto;
import com.mercadolibre.pf_be_hisp_w26_t10_mcaldera.exceptions.*;
...
public class ControllerExceptionHandler {
  ...
  /**
   * Not Access Exception
   *
   * @param e The exception message
   * @return Controller and message error
   */
