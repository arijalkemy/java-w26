...
import static com.mercadolibre.pf_be_hisp_w26_t10_mcaldera.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t10_mcaldera.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("mcalderaumba")
                .email("mateo.calderaumbarila@mercadolibre.com.co"));
