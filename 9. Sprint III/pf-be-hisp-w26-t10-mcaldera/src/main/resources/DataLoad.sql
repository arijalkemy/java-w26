...
INSERT INTO user_account (first_name, last_name, password, user_role, username) VALUES
                                                                                    ...
                                                                                    ('Super', 'User', '$2a$10$QEVeq1PdFum/M0CqrIHVQuMTkuYSI.CkdI6wEikAwwTiomrye2/Ha', 'SUPERVISOR', 'userSuper'),
                                                                                    ('Seller', 'User', '$2a$10$QEVeq1PdFum/M0CqrIHVQuMTkuYSI.CkdI6wEikAwwTiomrye2/Ha', 'SELLER', 'userSeller'),
                                                                                    ('Buyer', 'User', '$2a$10$QEVeq1PdFum/M0CqrIHVQuMTkuYSI.CkdI6wEikAwwTiomrye2/Ha', 'BUYER', 'userBuyer');
...
INSERT INTO product (category_id, name, price) VALUES
                                                   (1, 'Pizza de Pepperoni', 8.99),
                                                   (2, 'Zumo de Naranja Natural', 2.49),
                                                   (3, 'Lechuga Iceberg', 1.99),
                                                   (1, 'Filete de Salmón', 12.99),
                                                   (2, 'Yogur Natural', 0.99),
                                                   (3, 'Manzanas Gala', 3.49),
                                                   (1, 'Helado de Chocolate', 3.99),
                                                   (2, 'Queso Cheddar', 4.49),
                                                   (3, 'Ensalada César', 5.99),
                                                   (1, 'Pollo Congelado', 7.99),
                                                    (2, 'Queso Panela', 11.99),
                                                    (2, 'Gelatina Dani', 5.99);
