package com.mercadolibre.pf_be_hisp_w26_t01_moises.config;

import static com.mercadolibre.pf_be_hisp_w26_t01_moises.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t01_moises.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("Franco Moises")
                .email("franco.fmoises@mercadolibre.com"));
