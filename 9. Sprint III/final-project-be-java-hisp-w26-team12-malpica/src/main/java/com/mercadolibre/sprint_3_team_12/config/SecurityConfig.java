        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authRequest -> authRequest
                        .requestMatchers("/h2-console/**", "/auth/**").permitAll()
                                ...
                                .requestMatchers("/api/v1/fresh-products/addProduct").hasAuthority("ADMIN")
                                .requestMatchers("/api/v1/fresh-products/modifyProduct").hasAuthority("ADMIN")
                                .requestMatchers("/api/v1/fresh-products/listProdName").hasAuthority("USER")
