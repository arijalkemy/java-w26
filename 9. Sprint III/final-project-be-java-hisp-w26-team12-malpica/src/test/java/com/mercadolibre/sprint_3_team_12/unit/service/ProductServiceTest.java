...
public class ProductServiceTest {
    ...
    void firstErrorTestGetProductsByCategory(){
        ...
        //Assert
        Assertions.assertEquals("Not Acceptable",error.getCode());
        Assertions.assertEquals("The Category is not recognized",error.getMessage());
        Assertions.assertEquals(406,error.getStatusCode());
    }
