...
public class ProductControllerTest {
     ...
     */
    @Test
    @DisplayName("Test to get all products with name, happy path")
    void testGetProductsWithName() throws Exception {
        //Act
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/fresh-products/listProdName")
                        .header(HttpHeaders.AUTHORIZATION, "Bearer " + token))
                .andExpect(status().isOk())
                .andReturn();
        //Assert
