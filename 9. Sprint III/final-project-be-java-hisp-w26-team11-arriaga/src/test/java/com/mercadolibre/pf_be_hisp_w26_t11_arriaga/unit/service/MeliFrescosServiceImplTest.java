package com.mercadolibre.pf_be_hisp_w26_t11_arriaga.unit.service;
...
import com.mercadolibre.pf_be_hisp_w26_t11_arriaga.repository.IBatchRepository;
import com.mercadolibre.pf_be_hisp_w26_t11_arriaga.service.MeliFrescosServiceImpl;
...
//        Act & Assert
    ...
    public void createInboundOrderTest() {
        ...
        Assertions.assertEquals(100, inboundOrder.getOrderNumber());
