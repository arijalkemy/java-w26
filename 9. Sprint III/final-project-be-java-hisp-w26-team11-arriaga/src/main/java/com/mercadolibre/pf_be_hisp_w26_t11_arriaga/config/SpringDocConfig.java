package com.mercadolibre.pf_be_hisp_w26_t11_arriaga.config;
...
import static com.mercadolibre.pf_be_hisp_w26_t11_arriaga.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t11_arriaga.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("joperezherna")
                .email("jonathanfrancisco.perezhernandez@mercadolibre.com.mx"));
