...
import com.mercadolibre.pf_be_hisp_w26_t11_arriaga.jwt.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authRequest -> authRequest
                        ...
                        .requestMatchers("/api/v1/fresh-products/inboundorder/{inboundorderId}").hasAuthority(Role.WAREHOUSE.name())
