package com.mercadolibre.pf_be_hisp_w26_t7_villarraga.util;
...
import com.mercadolibre.pf_be_hisp_w26_t7_villarraga.dtos.order.OrderStatusRequestDTO;
...
import com.mercadolibre.pf_be_hisp_w26_t7_villarraga.dtos.warehouse.SectionRequestDTO;
...
public class DataUtils {
    ...
    public static LocationForProductDTO getJsonLocationProductoInWarehouse(Long idProduct) {
        ...
        listBSResponseDTO.add(BSResponseDTO.builder().id(1).dueDate(LocalDate.parse("2024-12-05")).currentQuantity(50).build());
        listBSResponseDTO.add(BSResponseDTO.builder().id(3).dueDate(LocalDate.parse("2034-12-05")).currentQuantity(60).build());
