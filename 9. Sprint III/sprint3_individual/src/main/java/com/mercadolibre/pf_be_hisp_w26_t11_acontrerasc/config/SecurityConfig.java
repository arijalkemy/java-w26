...
import com.mercadolibre.pf_be_hisp_w26_t11_acontrerasc.jwt.JwtAuthenticationFilter;
import com.mercadolibre.pf_be_hisp_w26_t11_acontrerasc.model.Role;
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authRequest -> authRequest
                       ...
                       .requestMatchers(HttpMethod.PUT,"/api/v1/fresh-products/orders").hasAuthority(Role.BUYER.name())
                        ...
                        .requestMatchers("/api/v1/fresh-products/add").hasAuthority(Role.SELLER.name())
                        .requestMatchers("/api/v1/fresh=products/update").hasAuthority(Role.SELLER.name())
                        .requestMatchers("/api/v1/fresh-products/add/bulk").hasAuthority(Role.SELLER.name())
                        .requestMatchers("/api/v1/fresh-products/list/batches").hasAuthority(Role.SELLER.name())
