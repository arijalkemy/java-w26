...
import static com.mercadolibre.pf_be_hisp_w26_t11_acontrerasc.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t11_acontrerasc.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("acontrerasch")
                .email("alexis.contreraschavez@mercadolibre.com.mx"));
