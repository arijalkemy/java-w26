package com.mercadolibre.pf_be_hisp_w26_t1_cassini.config;
...
import static com.mercadolibre.pf_be_hisp_w26_t1_cassini.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t1_cassini.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("ecassini")
                .email("elianapatricia.cassini@mercadolibre.com"));
