...
import com.mercadolibre.pf_be_hisp_w26_t1_cassini.dtos.BatchLocationDTO;
...
public class BatchMapper {
    ...
    public static BatchWrongTemperatureDTO toBatchWrongTemperatureDTO(Batch batch){
        return BatchWrongTemperatureDTO.builder()
                .batch_number(batch.getId())
                .current_temperature(batch.getCurrentTemperature())
                .minimum_temperature(batch.getMinimumTemperature())
                .degrees_above_minimum(batch.calculateDegreesAboveMinimum())
                .current_quantity(batch.getCurrentQuantity())
                .build();
    }
