...
public class TestUtil {
        ...
        static User userWithoutWarehouse = new User(4, "user", "$2a$12$9YkEaxhuL6Jblgm8Pd.TOuaPV9BvxdoBuoY3LaUn0kcJbzSwS.aE2", adminRole,"managerWithoutWarehouse@gmail.com",null);
        ...
        static Batch batch8 = new Batch(8, bananaProduct, inboundOrder1, 15.0, 20.0, 100, 0, LocalDate.of(2022,10,5), LocalDateTime.of(2022,10,5,10,0), LocalDate.of(2025,04,01));
        static Batch batch9 = new Batch(9, carneProduct, inboundOrder1, 30.0, 20.0, 100, 0, LocalDate.of(2022,10,5), LocalDateTime.of(2022,10,5,10,0), LocalDate.of(2025,04,01));
        static Batch batch10 = new Batch(10, carneProduct, inboundOrder1, 35.0, 20.0, 100, 0, LocalDate.of(2022,10,5), LocalDateTime.of(2022,10,5,10,0), LocalDate.of(2025,04,01));
        ...
        public static List<Batch>  getBatchListTemperature(){
                List<Batch> batchList= new ArrayList<>();
                batchList.add(batch1);
                batchList.add(batch8);
                return batchList;
        }
        public static List<Batch>  getBatchListCorrectTemperature(){
                final List<Batch> batchList= new ArrayList<>();
                batchList.add(batch8);
                return batchList;
        }

        public static List<BatchWrongTemperatureDTO>  getBatchListWrongTemperature(){
                BatchWrongTemperatureDTO batchWrongTemperatureDTO= BatchWrongTemperatureDTO.builder()
                                .batch_number(batch1.getId())
                                        .current_quantity(batch1.getCurrentQuantity())
                                                .current_temperature(batch1.getCurrentTemperature())
                                                        .minimum_temperature(batch1.getMinimumTemperature())
                                                                .degrees_above_minimum(batch1.calculateDegreesAboveMinimum())
                                                                        .build();
                List<BatchWrongTemperatureDTO> batchList = new ArrayList<>();
                batchList.add(batchWrongTemperatureDTO);
                return batchList;
        }

        public static BatchWrongTemperatureRespDTO getResponseWrongTemperature(){
                List<BatchWrongTemperatureDTO> batchList = getBatchListWrongTemperature();

                return BatchWrongTemperatureRespDTO.builder()
                        .product_id(bananaProduct.getId())
                        .batch_stock(batchList)
                        .build();
        }


        public static BatchWrongTemperatureRespDTO getResponseWrongTemperatureOrderedByQuantity(){
                List<Batch> batch= new ArrayList<>();
                batch.add(batch5);
                batch.add(batch1);
                List<BatchWrongTemperatureDTO> batchList = batch.stream()
                        .map(BatchMapper::toBatchWrongTemperatureDTO).toList();
                return BatchWrongTemperatureRespDTO.builder()
                        .product_id(1)
                        .batch_stock(batchList)
                        .build();
        ...
        public static BatchWrongTemperatureRespDTO getResponseWrongTemperatureOrderedByTemperature(){
                List<Batch> batch= new ArrayList<>();
                batch.add(batch5);
                batch.add(batch1);
                List<BatchWrongTemperatureDTO> batchList = batch.stream()
        ...
        public static BatchWrongTemperatureRespDTO getResponseWrongTemperatureOrderedByBatchNumber(){
                List<Batch> batch= new ArrayList<>();
                batch.add(batch1);
                batch.add(batch5);
                List<BatchWrongTemperatureDTO> batchList = batch.stream()
        ...
        public static User getUserWithoutWarehouse(){
                return userWithoutWarehouse;
        }

        public static Batch getBatchIncorrectTemperature(){
                return batch2;
        }

        public static Batch getBatchCorrectTemperature(){
                return batch8;
        }

        public static Batch getBatchUpdateTemperature(){
                return batch9;
        }
        public static Batch getBatchSadPath(){
                return batch10;
        }

        public static User getUser(){
                juanUser.setWarehouse(warehouseA);
               return juanUser;
        }
        public static List<ProductResponseDTO> getProductList(){
                List<ProductResponseDTO> products= new ArrayList<>();
                ProductResponseDTO banana= new ProductResponseDTO(bananaProduct.getName(),
                        bananaProduct.getPrice(),
                        bananaProduct.getCategory().getName());
                ProductResponseDTO manzana= new ProductResponseDTO(manzanaProduct.getName(),
                        manzanaProduct.getPrice(),
                        manzanaProduct.getCategory().getName());
                products.add(banana);
        ...
        public static BatchStockDTO getBatchResponseDTO(){
                batch1.setCurrentTemperature(10.0);
                return BatchMapper.toBatchStockDTO(batch1);
        }
