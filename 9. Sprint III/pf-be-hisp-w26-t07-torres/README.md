...
### Requerimiento 6
[Documento con requerimiento](https://docs.google.com/document/d/1mz2sSF1VQh-JKaxVzp4R738TOd72rzio/edit?usp=sharing&ouid=108863944036491869651&rtpof=true&sd=true)

| Method | Endpoint                                        | Body | Response                                                                   |
|--------|-------------------------------------------------|------|----------------------------------------------------------------------------|
| POST   | `/api/v1/fresh-products/{idSeller}`             | N/A  | - 200 OK <br> - 404 Not Found <br> - 401 Unauthorized <br> - 403 Forbidden |
| PUT    | `/api/v1/fresh-products/{idSeller}/{idProduct}` | N/A  | - 200 OK <br> - 404 Not Found <br> - 401 Unauthorized <br> - 403 Forbidden |
| GET    | `/api/v1/batches/temperature-difference`        | N/A  | - 200 OK <br> - 404 Not Found <br> - 401 Unauthorized <br> - 403 Forbidden |
| GET    | `/api/v1/batches/low-stock`                     | N/A  | - 200 OK <br> - 404 Not Found <br> - 401 Unauthorized <br> - 403 Forbidden |
