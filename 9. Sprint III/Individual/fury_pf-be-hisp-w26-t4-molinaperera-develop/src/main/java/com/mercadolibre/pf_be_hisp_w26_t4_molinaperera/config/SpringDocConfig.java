package com.mercadolibre.pf_be_hisp_w26_t4_molinaperera.config;

import static com.mercadolibre.pf_be_hisp_w26_t4_molinaperera.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_hisp_w26_t4_molinaperera.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("fmolinaperer")
                .email("facundosebastian.molinaperera@mercadolibre.com"));
