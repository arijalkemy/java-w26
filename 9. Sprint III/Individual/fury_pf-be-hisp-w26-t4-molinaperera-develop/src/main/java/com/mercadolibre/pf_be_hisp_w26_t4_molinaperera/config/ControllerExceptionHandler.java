...
import com.mercadolibre.pf_be_hisp_w26_t4_molinaperera.dtos.response.ExceptionDTO;
...
public class ControllerExceptionHandler {
  ...
  @ExceptionHandler(InvalidEndDatePromoException.class)
    public ResponseEntity<?> InvalidEndDatePromoException(InvalidEndDatePromoException ex) {
        return ResponseEntity
