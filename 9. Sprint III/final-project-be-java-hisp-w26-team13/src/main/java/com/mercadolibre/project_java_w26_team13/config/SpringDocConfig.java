package com.mercadolibre.project_java_w26_team13.config;

import static com.mercadolibre.project_java_w26_team13.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.project_java_w26_team13.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("gpalomo")
                .email("gonzalo.palomo@mercadolibre.com"));
