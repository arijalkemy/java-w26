...
import static com.mercadolibre.final_project_java_h_w26_t10.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.final_project_java_h_w26_t10.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("jgarciavarga")
                .email("johnstiven.garciavargas@mercadolibre.com.co"));
