...
public class VehiculoController {
    ...
    public ResponseEntity<List<VehiculoDTO>> listarVehiculosSiniestroMayorADiezMil() {
    ...
    public ResponseEntity<VehiculosPerdidaTotalDTO> listarVehiculosSiniestroMayorADiezMilYTotal() {
        return new ResponseEntity<>(
