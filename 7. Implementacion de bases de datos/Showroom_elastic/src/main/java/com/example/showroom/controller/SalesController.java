...
public class SalesController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RespSalesDto> getSalesById(@PathVariable String id) {
        return new ResponseEntity<>(salesService.getSalesById(id), HttpStatus.OK);
    }

    @PutMapping("/{id}")
    public ResponseEntity<InfoMessageDto> updateSale(@PathVariable String id, @RequestBody RequestUpdateSaleDto updatedSale) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<InfoMessageDto> deleteSaleById(@PathVariable String id) {
    ...
    public ResponseEntity<List<RespClothesDto>> getClothesBySale(@PathVariable String id) {
