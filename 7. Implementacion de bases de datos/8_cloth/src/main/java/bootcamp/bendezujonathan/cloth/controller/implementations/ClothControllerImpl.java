...
public class ClothControllerImpl implements ClothController {
    ...
    @Override
    public ResponseEntity<ClothResponse> getById(long id) {
    ...
    @Override
    public ResponseEntity<Void> putCloth(Long id, ClothRequest req) {
    ...
    @Override
    public ResponseEntity<Void> deleteCloth(Long id) {
        service.delete(id);
        return ResponseEntity.noContent()
                .build();
    }
