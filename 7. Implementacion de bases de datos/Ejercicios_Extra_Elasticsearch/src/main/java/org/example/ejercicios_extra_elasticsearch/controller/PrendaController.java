...
import org.example.ejercicios_extra_elasticsearch.service.IPrendaService;
...
public class PrendaController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<PrendaDto> buscarPrendaPorId(@PathVariable("id") String idPrenda) {
    ...
    public ResponseEntity<PrendaDto> actualizarPrendaPorId(
        @PathVariable("id") String idPrenda,
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> eliminarPrendaPorId(@PathVariable("id") String idPrenda) {
