...
public class SalesController {
    ...
    public ResponseEntity<List<ClothDTO>> getClothesOfSale(@PathVariable Long number) {
        return new ResponseEntity<>(salesService.searchClothesOfSale(number), HttpStatus.OK);
    }
