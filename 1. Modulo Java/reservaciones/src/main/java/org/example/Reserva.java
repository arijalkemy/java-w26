...
public class Reserva {
    ...
    public int cantidadProductosPaquete(){
        return this.paquete.getBoletos().size() + this.paquete.getComidas().size()
                + this.paquete.getHotels().size() + this.paquete.getTransportes().size();
    }
