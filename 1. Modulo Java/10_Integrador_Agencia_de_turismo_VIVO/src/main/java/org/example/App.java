...
public class App {
    public static void main(String[] args) {
        ...
        LocalizadorTuristico paquete1 = new LocalizadorTuristico(
            new Cliente("Pepito", 29, "12312312"),
            List.of(
                new Reserva("hotel", 200),
                new Reserva("comida", 120)
            )
        );
        ...
        System.out.println("Cantidad de localizadores vendidos: " + Consulta.calcularCantidadLocalizadores(repositorio.getLocalizadores()));
        System.out.println("Cantidad de reservas: " + Consulta.calcularCantidadReservas(repositorio.getLocalizadores()));
    }
}
