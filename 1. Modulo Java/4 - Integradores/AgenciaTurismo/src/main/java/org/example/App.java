...
public class App
{
    ...
    public static void main( String[] args )
    {
        ...
        Gestor.mostrarTotalLocalizadores();
        Gestor.mostrarCantidadProductos();

        double totalNoDescuento = Gestor.calcularTotalDeVentas(false);
        double totalDescuento = Gestor.calcularTotalDeVentas(true);

        System.out.println("Total con descuento: " + totalDescuento);
        System.out.println("Total sin descuento: " + totalNoDescuento);

        Gestor.mostrarPromedioVentas(totalDescuento);
        Gestor.mostrarPromedioVentas(totalNoDescuento);
        Gestor.obtenerDiccionario();
    }
    ...
    public Repositorio getReservaciones() {
        return reservaciones;
    }

    public void setReservaciones(Repositorio reservaciones) {
