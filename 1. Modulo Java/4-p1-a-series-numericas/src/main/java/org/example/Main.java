...
de devolver un número que corresponderá al valor siguiente a la serie progresiva. Otro método para reiniciar la serie,
...
public class Main {
    public static void main(String[] args) {
        Prototipo<Integer> serie1 = new Prototipo<>(2,  2); // Crear una serie con valor inicial, actual e incremento de 2
        for (int i = 0; i < 4; i++) {
            System.out.println("Valor siguiente en la serie: " + serie1.obtenerSiguiente());
        }

        serie1.reiniciarSerie(3);
        for (int i = 0; i < 4; i++) {
            System.out.println("Valor siguiente en la serie reiniciada: " + serie1.obtenerSiguiente());
        }

        serie1.reiniciarSerie(3);
        serie1.setIncremento(3);
        for (int i = 0; i < 4; i++) {
            System.out.println("Valor siguiente en la serie reiniciada y cambio step: " + serie1.obtenerSiguiente());
        }
    }
}