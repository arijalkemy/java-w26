...
public class Main {
    public static void main(String[] args) {
        ...
        switch (valor) {
            ...
            case 0: System.out.println(personaCompleta.getNombre()+" tiene un peso saludable"); break;
            case 1: System.out.println(personaCompleta.getNombre()+" tiene sobrepeso"); break;
        }
    }
}